  ...
  return (
    <DrawerContentScrollView>
      <DrawerItem
        label={() => (
          <View style={{ alignItems: 'center' }}>
            <Image
              style={{ width: '100%', height: 35, resizeMode: 'contain', marginLeft: 30 }}
              source={{ uri: 'https://www.tiendauroi.com/wp-content/uploads/2020/02/bhd-star-cinema.png' }}
            ></Image>
          </View>
        )}
      ...
      <DrawerItem
        ...
        style={{ borderBottomColor: '#4f4f4f', borderBottomWidth: 1 }}
        onPress={() => navigation.navigate('ShowTimesStack')}
      />
      <DrawerItem
        label={() => (
          <View style={{ width: '100%', flexDirection: 'row', alignItems: 'center' }}>
