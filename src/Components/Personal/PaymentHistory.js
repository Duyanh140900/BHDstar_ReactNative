        ...
        return (
            <View style={{ backgroundColor: '#020200', height: "100%" }}>
                ...
                <View style={{ justifyContent: "center", alignItems: "center", marginTop: 150 }}>
                    ...
                    <Text style={{ color: '#d9d9d9', marginBottom: 30, fontSize: 14, fontWeight: "300", marginTop: 10 }}>No transactions</Text>
                    <TouchableOpacity onPress={()=> this.props.navigation.navigate("TabRoutes")}
                        style={{
